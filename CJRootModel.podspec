...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  Quickly help developers implement single iQuickly help developers implement singleton models. 
  Quick JSON rotation model, dictionary model, model JSON and model dictionary. 
  Support non singleton model
                   DESC

  s.homepage     = "https://github.com/chjsun/rootModel.git"
  ...
  s.source       = { :git => "https://github.com/chjsun/rootModel.git", :tag => "#{s.version}" }
